...
const InsightsPanel = ({ insights }) => {
  ...
  return (
    <motion.section 
      ...
      animate="show"
      variants={container}
      className="p-8 rounded-3xl bg-white/70 dark:bg-slate-800/80 backdrop-blur-xl border border-[#c9d7e3]/40 dark:border-slate-700/50 shadow-xl h-full flex flex-col relative overflow-hidden"
    >
